// required imports used in the project
import java.util.*;
import java.io.*;
...
class Student
{
	...
	// student class for keeping various details of student 
...
public class library_management 
{
	...
	static void display(Student[] students) {
		for (Student student : students) {
			...
			System.out.println(); // Adding an empty line for better separation between students
		}
	}
						...
						switch(ch2)
						{
							...
							case 3:		//To update any book
									...
									if(z==true)
									{
										...
										System.out.println(" Enter quantity of book to add more:");
										int q = input.nextInt();
										arr[a][0]+=q;
							...
							case 4:
                                for (String book : hashmapping.keySet()) {
                                    int u = hashmapping.get(book);
                                    System.out.println("Book Name: " + book + "  -  Quantity of book available: " +
                                            (arr[u][0] - arr[u][1]));
                                }
					...
					case 1://To issue a book
							...
							if(x==true)
							{
								...
								if(arr[a][1]>0)
								{
									...
									br.write(" Student name:	" + array[index].name);
									br.write(" Student ID  :	" + array[index].id_no);
									br.write(" Issued Book :	" + book);
									br.write(" Issued date :	" + formatter.format(Cday));
									br.write(" Return date :	" + formatter.format(Rday1));
									
								}
								else
									System.out.println("You can not issue book now. Try again after some days");
							}
							else
